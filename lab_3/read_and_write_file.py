...
from cryptography.hazmat.primitives.serialization import load_pem_private_key #PEM: Privacy Enhanded Mail
import logging
import json
...
def write_asymmetric_key(private_key, public_key, private_pem: str, public_pem: str) -> None:
    """
